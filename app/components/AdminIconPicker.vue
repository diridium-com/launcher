...
<template>
  <div class="space-y-1.5">
    <label class="block text-sm font-medium text-text-secondary select-none">Icon</label>
    ...
    <div class="relative">
      <button
        ...
        @click="toggle"
      >
        <img v-if="currentIconData" :src="currentIconData" class="size-8 rounded-md" alt="Connection icon" />
        <span
          v-else
